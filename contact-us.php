                ...
                <div class="row">
                    <!-- <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="text-content">
                            ...
                            <p>Our Expertise team can help you in:</p>
                        </div>
                        <div class="text-content bg-dark-custom">
                            <h3 class="text-white">Understanding International Trade Regulations</h3>
                            <p class="text-white">
                                One of the primary areas where our experts can assist you is in understanding and
                        ...
                        <div class="text-content bg-dark-custom">
                            ...
                            <p class="text-white">
                                Another crucial aspect of successful international trade is conducting effective market
                                research. Our experts at TradeImeX can provide you with valuable insights and analysis
                                on various global markets.
                            </p>
                        </div>
                        <div class="text-content bg-dark-custom">
                            <h3 class="text-white">
                                Buyer/Supplier Sourcing and Verification
                            </h3>
                            <p class="text-white">
                                Finding reliable buyers and suppliers who can meet your quality and quantity
                                requirements is crucial for any import-export business. Our expert team identifies
                                reputable partners, conducts due diligence, and negotiates favorable terms.
                            </p>
                        </div>
                        <div class="text-content bg-dark-custom">
                            <h3 class="text-white">
                                Customization of data package
                            </h3>
                            <p class="text-white">
                                We can also assist you with how we customize a data package as per the client&#39;s data
                                requirements and ensure the delivery of accurate and relevant information. After
                                understanding the client’s data needs, we will prepare a customized data package for
                                them accordingly with the help of our expertise.
                            </p>
                        </div>
                    </div> -->
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="contact-form">
                            <form action="backend/query_form.php" id="contact-form" class="form-control" method="post" style="border: 0px;">
