        ...
        <div class="container-fluid pdt-2 pdb-2 bg-bluish">
            <div class="container">
                <div class="text-content text-center">
                    <h1>COPYRIGHT & TRADEMARK ACKNOWLEDGEMENT</h1>
                </div>
            </div>
        </div>

        <div class="container-fluid pdb-2 bg-bluish">
            <div class="container">
                <div class="text-content">
                    <p>
                        The TradeImeX logos TradeImeX® and marks appearing in this site are 
                        registered in the name of TRADEIMEX or are used under license by its 
                        affiliates in the areas where TRADEIMEX Services bearing these trademarks. 
                        The use or misuse of these trademarks or any other content on this site, is 
                        strictly prohibited. All rights reserved.
                    </p>
                    <p>
                        TradeImeX® provides the insert URL here website as a service to the public. 
                        TradeImeX® is not responsible for, and expressly disclaims all liability for, 
                        damages of any kind arising out of use, reference to, or reliance on any information 
                        contained within this website.
                    </p>
                    <p>
                        While the information contained within this website is periodically updated, 
                        no guarantee is given that the information provided in this website is correct, 
                        complete, and up-to-date.
                    </p>
                    <p>
                        Through this website you are able to link to other websites which are not under the 
                        control of TradeImeX® We have no control over the nature, content and availability 
                    ...
                    <p>
                        ...
                        TradeImeX® takes no responsibility for, and will not be liable for, the website 
                        being temporarily unavailable due to technical issues beyond our control.
                    </p>
                    <p>
                        The TradeImeX® website does not host or receive funding from advertising or from the 
